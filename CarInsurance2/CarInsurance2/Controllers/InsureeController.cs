...
namespace CarInsurance2.Controllers
{
    public class InsureeController : Controller
    {
        ...
        private decimal getQuote(Insuree insuree)
        {
            ...
            if(insuree.CarModel == "Porsche" && insuree.CarMake == "911 Carrera")
            {
                quote += 50;
            }else if (insuree.CarModel == "Porsche")
            {
                quote += 25; 
            }

            decimal ticketPendalty = 10 * insuree.SpeedingTickets;
            quote += ticketPendalty;
